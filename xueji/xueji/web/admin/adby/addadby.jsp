...
<html>
    <head>
        ...
        <title>添加学生毕业信息</title>
    </head>
    <body bgcolor="lightgreen">
        <form action="http://localhost:8080/xueji/admin/adby/addadbyCheck.jsp" method="post">
            ...
            <table align="center"width="300" >
                 <tr>
                     <th colspan="4" align="center">添加学生毕业信息</th>
                 </tr>
                 <tr>
                     <td>毕业编号</td>
