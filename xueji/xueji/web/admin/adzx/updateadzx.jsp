...
<html>
    <head>
        ...
        <title>修改学生转休信息</title>
    </head>
    <body bgcolor="lightgreen">
        <form action="http://localhost:8080/xueji/admin/adzx/updateadzxCheck.jsp" method="post">
            ...
            <table align="center"width="300" >
                 <tr>
                     <th colspan="4" align="center">修改学生转休信息</th>
                     </tr>
                     <tr>
                     <td>修改的学号</td>
